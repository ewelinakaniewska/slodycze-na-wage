                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Cena: {{ $candy->price }}</p>
                                <p class="card-text">Dostępna ilość: {{ $candy->stock }}</p>
                                <label for="quantity_{{ $candy->id }}">Ilość:</label>
                                <input type="number" class="form-control" id="quantity_{{ $candy->id }}" name="products[{{ $candy->id }}]" min="0">
                            </div>
                        </div>
                    </div>
                @endforeach
