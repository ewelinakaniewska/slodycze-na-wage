...
@include('shared.head', ['pageTitle' => 'Edytuj Dostawcę'])
<body>
        ...
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route('suppliers.update', $supplier->id) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('notes') is-invalid @enderror" id="notes" name="notes">{{ old('notes', $supplier->notes) }}</textarea>
                    @error('notes')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
