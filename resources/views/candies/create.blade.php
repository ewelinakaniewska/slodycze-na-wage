            ...
            <div class="container">
                ...
                <form method="POST" action="{{ route('candies.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <textarea id="ingredients" name="ingredients" class="form-control @if ($errors->first('ingredients')) is-invalid @endif">{{ old('ingredients') }}</textarea>
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="stock" name="stock" type="text" class="form-control @if ($errors->first('stock')) is-invalid @endif" value="{{ old('stock') }}">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input id="rating" name="rating" type="text" class="form-control @if ($errors->first('rating')) is-invalid @endif" value="{{ old('rating') }}">
